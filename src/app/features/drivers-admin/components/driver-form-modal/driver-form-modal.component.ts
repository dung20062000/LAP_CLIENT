...
@Component({
  ...
  standalone: true,
  // prettier-ignore
  imports: [CommonModule, FormsModule, ReactiveFormsModule, NgSelectModule, DialogModule, DatePickerModule, NumbersOnlyDirective, VarcharOnlyDirective, NoAngleBracketsDirective, FormatDatePipe, IsExpiredPipe, FormErrorPipe],
    ...
    this.form = this.fb.group(
      {
        ...
        Mobile: [
          driver?.Mobile ?? '',
          [Validators.pattern(/^[0-9]{9,25}$/), Validators.maxLength(25)],
        ],
        DriverLicense: [
